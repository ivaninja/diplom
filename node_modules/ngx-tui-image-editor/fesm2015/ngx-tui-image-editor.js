...
import { Component, EventEmitter, Input, ViewChild, Output, ViewEncapsulation, NgModule } from '@angular/core';
...
class ToastUiImageEditorComponent {
    constructor() {
        this.includeUI = true;
        this.addText = new EventEmitter();
        this.mousedown = new EventEmitter();
        this.objectActivated = new EventEmitter();
        this.objectMoved = new EventEmitter();
        this.objectScaled = new EventEmitter();
        this.redoStackChanged = new EventEmitter();
        this.textEditing = new EventEmitter();
        this.undoStackChanged = new EventEmitter();
    }
    /**
     * @return {?}
     */
     ...
     */
    addEventListeners() {
        this.editorInstance.on(editorEvents.addText, event => this.addText.emit(event));
        this.editorInstance.on(editorEvents.mousedown, (event, originPointer) => this.mousedown.emit({ event, originPointer }));
        this.editorInstance.on(editorEvents.objectActivated, event => this.objectActivated.emit(event));
        this.editorInstance.on(editorEvents.objectMoved, event => this.objectMoved.emit(event));
        this.editorInstance.on(editorEvents.objectScaled, event => this.objectScaled.emit(event));
        this.editorInstance.on(editorEvents.redoStackChanged, event => this.redoStackChanged.emit(event));
        this.editorInstance.on(editorEvents.textEditing, () => this.textEditing.emit());
        this.editorInstance.on(editorEvents.undoStackChanged, event => this.undoStackChanged.emit(event));
    }
    /**
     * @return {?}
     */
    removeEventListeners() {
        (/** @type {?} */ (this.editorInstance)).off(editorEvents.addText);
        (/** @type {?} */ (this.editorInstance)).off(editorEvents.mousedown);
        (/** @type {?} */ (this.editorInstance)).off(editorEvents.objectActivated);
        (/** @type {?} */ (this.editorInstance)).off(editorEvents.objectMoved);
        (/** @type {?} */ (this.editorInstance)).off(editorEvents.objectScaled);
        (/** @type {?} */ (this.editorInstance)).off(editorEvents.redoStackChanged);
        (/** @type {?} */ (this.editorInstance)).off(editorEvents.textEditing);
        (/** @type {?} */ (this.editorInstance)).off(editorEvents.undoStackChanged);
    }
}
ToastUiImageEditorComponent.decorators = [
    { type: Component, args: [{
  ...
  `,
                ...
                .tui-image-editor-container
                  ...
                  > .tui-image-editor-item[title]:hover:before {
                  content: "";
                  display: inline-block;
                  margin: 0 auto;
                  width: 0;
                ...
                .tui-image-editor-container
                  .tui-image-editor-menu
                  > .tui-image-editor-item[title]:hover:after {
                  content: attr(title);
                  position: absolute;
                  display: inline-block;
                ...
                .tui-image-editor-container.left
                  .tui-image-editor-menu
                  > .tui-image-editor-item[title]:before {
                  left: 28px;
                  top: 11px;
                ...
                .tui-image-editor-container.left
                  .tui-image-editor-menu
                  > .tui-image-editor-item[title]:after {
                  top: 7px;
                  left: 39px;
                  white-space: nowrap;
                }
...
ToastUiImageEditorComponent.propDecorators = {
    includeUI: [{ type: Input }],
    options: [{ type: Input }],
    addText: [{ type: Output }],
    mousedown: [{ type: Output }],
    objectActivated: [{ type: Output }],
    objectMoved: [{ type: Output }],
    objectScaled: [{ type: Output }],
    redoStackChanged: [{ type: Output }],
    textEditing: [{ type: Output }],
    undoStackChanged: [{ type: Output }],
    editorRef: [{ type: ViewChild, args: ["imageEditor",] }]
};
 ...
 * @suppress {checkTypes,extraRequire,uselessCode} checked by tsc
 */
class ToastUiImageEditorModule {
}
ToastUiImageEditorModule.decorators = [
    { type: NgModule, args: [{
                imports: [],
...
export { ToastUiImageEditorComponent, ToastUiImageEditorModule };

//# sourceMappingURL=ngx-tui-image-editor.js.map
